    ...
    self.derive = function (callback) {
        ...
        const __getPrivateKeyForSlot = () => {
            enclave.getPrivateKeyForSlot(slot, (err, _privateKey) => {
                ...
                console.log("===========================================================================================");
                console.log("PRIVATE KEY", JSON.stringify(_privateKey));
                try {
                    privateKey = _privateKey;
                    console.log("DATA TO HASH", `${path}${toString(privateKey)}`)
                    privateKey = cryptoRegistry.getHashFunction(self)(`${path}${toString(privateKey)}`);
                    console.log("HASHED DATA", privateKey);
                    privateKey = cryptoRegistry.getDecodingFunction(self)(privateKey);
                    console.log("DECODED DATA", privateKey);
                    const seedSpecificString = cryptoRegistry.getBase64EncodingFunction(self)(privateKey);
                    console.log("SEED SPECIFIC STRING", seedSpecificString);
                    ...
                    console.log("SEED SSI", seedSSI.getIdentifier());
                    console.log("ANCHOR ID", seedSSI.getAnchorIdSync());
                    console.log("===========================================================================================");
