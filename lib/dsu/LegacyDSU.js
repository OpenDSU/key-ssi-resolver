function LegacyDSU(bar, dsuInstancesRegistry) {
    ...
    this.writeFile = (path, data, options, callback) => {
        ...
        dsuInstancesRegistry.executeOrDelayAction(this, "writeFile", path, data, options, callback);
    }
    ...
    this.embedFile = (path, data, options, callback) => {
        ...
        dsuInstancesRegistry.executeOrDelayAction(this, "embedFile", path, data, options, callback);
    }
    ...
    this.delete = (path, options, callback) => {
        dsuInstancesRegistry.executeOrDelayAction(this, "delete", path, options, callback);
    }

    this.rename = (srcPath, dstPath, options, callback) => {
        dsuInstancesRegistry.executeOrDelayAction(this, "rename", srcPath, dstPath, options, callback);
    }
    ...
    this.createFolder = (barPath, options, callback) => {
        dsuInstancesRegistry.executeOrDelayAction(this, "createFolder", barPath, options, callback);
    }
    ...
    this.mount = (path, archiveSSI, options, callback) => {
        dsuInstancesRegistry.executeOrDelayAction(this, "mount", path, archiveSSI, options, callback);
    }

    this.unmount = (path, callback) => {
        dsuInstancesRegistry.executeOrDelayAction(this, "unmount", path, archiveSSI, options, callback);
    };
    ...
    this.beginBatch = () => {
        dsuInstancesRegistry.executeOrDelayAction(this, "beginBatch");
    }
    ...
    this.commitBatch = (callback) => {
        dsuInstancesRegistry.commitBatch(this, callback);
    };

    this.refresh = (callback) => {
        dsuInstancesRegistry.refresh(this, callback);
    };
