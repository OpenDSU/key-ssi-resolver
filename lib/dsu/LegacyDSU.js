function LegacyDSU(bar, dsuIdentityExtension) {
    ...
    this.writeFile = (path, data, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "writeFile", path, data, options, callback);
    }

    this.embedFile = (path, data, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "embedFile", path, data, options, callback);
    }
    ...
    this.delete = (path, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "delete", path, options, callback);
    }

    this.rename = (srcPath, dstPath, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "rename", srcPath, dstPath, options, callback);
    }
    ...
    this.createFolder = (barPath, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "createFolder", barPath, options, callback);
    }
    ...
    this.mount = (path, archiveSSI, options, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "mount", path, archiveSSI, options, callback);
    }

    this.unmount = (path, callback) => {
        dsuIdentityExtension.executeOrDelayAction(this, "unmount", path, archiveSSI, options, callback);
    };
