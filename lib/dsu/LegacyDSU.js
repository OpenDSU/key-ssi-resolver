...
function LegacyDSU(bar, dsuInstancesRegistry) {
    ...
    this.beginBatch = () => {
        ...
        $$.debug.logDSUEvent(this, "Virtual batch started", batchId);
        return batchId;
    }
    ...
    this.refresh = (callback) => {
        $$.debug.logDSUEvent(this, "Refresh called", inProgressBatches.size);
    ...
    this.notifyOnCommitBatch = ()=>{
        $$.debug.logDSUEvent(this, "notifyOnCommitBatch  Having ", listeners.keys().length, " listeners");
