...
function RaceConditionPreventer() {
    ...
    async function dumpBatchInfo(){
        ...
        let mainAnchorId = mainDSU.getAnchorIdSync(true);
    ...
    function dumpLocks(){
        console.log(`\tCurrent locks ${JSON.stringify(Object.keys(locks))}`);
    }
